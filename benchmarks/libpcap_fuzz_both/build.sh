...
# build fuzz targets
$CC $CFLAGS -I.. -c ../testprogs/fuzz/fuzz_both.c -fPIC -o fuzz_both.o
$CXX $CXXFLAGS fuzz_both.o -o $OUT/fuzz_both libpcap.a $LIB_FUZZING_ENGINE
# cp libpcap.a $OUT/libpcap.a
# cp fuzz_both.o $OUT/fuzz_both
#cp $LIB_FUZZING_ENGINE $OUT/$LIB_FUZZING_ENGINE
