...
${VENV_ACTIVATE}: requirements.txt
	...
	source ${VENV_ACTIVATE} && python3 -m pip install --upgrade pip setuptools -i https://pypi.tuna.tsinghua.edu.cn/simple && python3 -m pip install -r requirements.txt -i https://pypi.tuna.tsinghua.edu.cn/simple
